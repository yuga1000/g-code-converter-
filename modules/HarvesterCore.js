// HarvesterCore V4.1 - Clean version with fixes (no YouTube)
...
class HarvesterCore {
    constructor(system) {
        ...
        this.logger.info('[◉] HarvesterCore V4.1 initialized (clean version)');
    }
    ...
    async initialize() {
        try {
            this.logger.info('[▸] Initializing HarvesterCore V4.1 for PRODUCTION...');
            ...
            this.logger.success('[✓] HarvesterCore V4.1 PRODUCTION ready');
            
            return { success: true, message: 'HarvesterCore V4.1 initialized' };
    ...
    async start() {
        ...
        try {
            ...
            this.logger.success('[◉] HarvesterCore V4.1 started in PRODUCTION MODE');
            ...
            return { 
                success: true, 
                message: '[◉] HarvesterCore V4.1 activated in PRODUCTION MODE'
            };
